...
{Author \MakeLowercase{\textit{et al.}}: Optical multiplexer/demultiplexer specification document (December 2023)}
\definecolor{abstractbg}{rgb}{0.89804,0.94510,0.83137}
\setlength{\fboxrule}{0pt}
\setlength{\fboxsep}{0pt}
\addbibresource{s7_advanced_telecom.bib} % Import bibliography file
\begin{document}
\title{Optical multiplexer/demultiplexer specification document (December 2023)}
